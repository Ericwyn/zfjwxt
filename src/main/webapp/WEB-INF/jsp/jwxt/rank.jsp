...
<form id="searchForm" name="searchForm"  action="rank" method="get" class="form-horizontal sl_all_form" novalidate="novalidate">
...
<div class="col-md-3 col-sm-6">
    <div class="form-group">
      <label for="" class="col-sm-4 control-label">统计类型</label>
      <div class="col-sm-8">
        <select name="tjlx" id="tjlx" class="form-control chosen-select" style="">
    
    <option value="2">临时查询</option>
    <option value="1">结果查询</option>
